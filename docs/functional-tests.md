...
Send CPA, address diff. than 99 chars or 187 chars | error: address invalid
Send CPA, address not start by CPA | error: address invalid
Send CPA, amount is 0 or less | error: amount should be greater than 0
Send CPA, amount is not a number | error: amount invalid
Send CPA, amount + fee is more than available balance | error: available balance is insufficient
Send CPA, small valid amount | dialog for confirming transfer. After confirmation, popup CPA sent. amount is received on the other end
Send CPA, invalid payment id | error: wrong payment id format
Send CPA, valid payment id | popup CPA sent. amount is received on the other end with correct payment id
Send CPA, valid integrated address | popup CPA sent. amount is received on the other end with correct payment id from integrated address
...
Display in USD enabled -> Open a wallet| Balance is displayed in USD (under CPA balance)
