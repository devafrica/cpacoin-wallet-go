...
//export callbackQmlBridgef074ca_Constructor
func callbackQmlBridgef074ca_Constructor(ptr unsafe.Pointer) {
	this := NewQmlBridgeFromPointer(ptr)
	qt.Register(ptr, this)
}

//export callbackQmlBridgef074ca_DisplayTotalBalance
func callbackQmlBridgef074ca_DisplayTotalBalance(ptr unsafe.Pointer, balance C.struct_Moc_PackedString, balanceUSD C.struct_Moc_PackedString) {
...
func (ptr *QmlBridge) ConnectDisplayTotalBalance(f func(balance string, balanceUSD string)) {
	if ptr.Pointer() != nil {
		...
		if !qt.ExistsSignal(ptr.Pointer(), "displayTotalBalance") {
			C.QmlBridgef074ca_ConnectDisplayTotalBalance(ptr.Pointer(), C.longlong(qt.ConnectionType(ptr.Pointer(), "displayTotalBalance")))
		}
...
func (ptr *QmlBridge) DisconnectDisplayTotalBalance() {
	if ptr.Pointer() != nil {
		C.QmlBridgef074ca_DisconnectDisplayTotalBalance(ptr.Pointer())
...
func (ptr *QmlBridge) DisplayTotalBalance(balance string, balanceUSD string) {
	if ptr.Pointer() != nil {
		...
		C.QmlBridgef074ca_DisplayTotalBalance(ptr.Pointer(), C.struct_Moc_PackedString{data: balanceC, len: C.longlong(len(balance))}, C.struct_Moc_PackedString{data: balanceUSDC, len: C.longlong(len(balanceUSD))})
	}
}

//export callbackQmlBridgef074ca_DisplayAvailableBalance
func callbackQmlBridgef074ca_DisplayAvailableBalance(ptr unsafe.Pointer, data C.struct_Moc_PackedString) {
...
func (ptr *QmlBridge) ConnectDisplayAvailableBalance(f func(data string)) {
	if ptr.Pointer() != nil {
		...
		if !qt.ExistsSignal(ptr.Pointer(), "displayAvailableBalance") {
			C.QmlBridgef074ca_ConnectDisplayAvailableBalance(ptr.Pointer(), C.longlong(qt.ConnectionType(ptr.Pointer(), "displayAvailableBalance")))
		}
...
func (ptr *QmlBridge) DisconnectDisplayAvailableBalance() {
	if ptr.Pointer() != nil {
		C.QmlBridgef074ca_DisconnectDisplayAvailableBalance(ptr.Pointer())
...
func (ptr *QmlBridge) DisplayAvailableBalance(data string) {
	if ptr.Pointer() != nil {
		...
		C.QmlBridgef074ca_DisplayAvailableBalance(ptr.Pointer(), C.struct_Moc_PackedString{data: dataC, len: C.longlong(len(data))})
	}
}

//export callbackQmlBridgef074ca_DisplayLockedBalance
func callbackQmlBridgef074ca_DisplayLockedBalance(ptr unsafe.Pointer, data C.struct_Moc_PackedString) {
...
func (ptr *QmlBridge) ConnectDisplayLockedBalance(f func(data string)) {
	if ptr.Pointer() != nil {
		...
		if !qt.ExistsSignal(ptr.Pointer(), "displayLockedBalance") {
			C.QmlBridgef074ca_ConnectDisplayLockedBalance(ptr.Pointer(), C.longlong(qt.ConnectionType(ptr.Pointer(), "displayLockedBalance")))
		}
...
func (ptr *QmlBridge) DisconnectDisplayLockedBalance() {
	if ptr.Pointer() != nil {
		C.QmlBridgef074ca_DisconnectDisplayLockedBalance(ptr.Pointer())
...
func (ptr *QmlBridge) DisplayLockedBalance(data string) {
	if ptr.Pointer() != nil {
		...
		C.QmlBridgef074ca_DisplayLockedBalance(ptr.Pointer(), C.struct_Moc_PackedString{data: dataC, len: C.longlong(len(data))})
	}
}

//export callbackQmlBridgef074ca_DisplayAddress
func callbackQmlBridgef074ca_DisplayAddress(ptr unsafe.Pointer, address C.struct_Moc_PackedString, wallet C.struct_Moc_PackedString, displayFiatConversion C.char) {
...
func (ptr *QmlBridge) ConnectDisplayAddress(f func(address string, wallet string, displayFiatConversion bool)) {
	if ptr.Pointer() != nil {
		...
		if !qt.ExistsSignal(ptr.Pointer(), "displayAddress") {
			C.QmlBridgef074ca_ConnectDisplayAddress(ptr.Pointer(), C.longlong(qt.ConnectionType(ptr.Pointer(), "displayAddress")))
		}
...
func (ptr *QmlBridge) DisconnectDisplayAddress() {
	if ptr.Pointer() != nil {
		C.QmlBridgef074ca_DisconnectDisplayAddress(ptr.Pointer())
...
func (ptr *QmlBridge) DisplayAddress(address string, wallet string, displayFiatConversion bool) {
	if ptr.Pointer() != nil {
		...
		C.QmlBridgef074ca_DisplayAddress(ptr.Pointer(), C.struct_Moc_PackedString{data: addressC, len: C.longlong(len(address))}, C.struct_Moc_PackedString{data: walletC, len: C.longlong(len(wallet))}, C.char(int8(qt.GoBoolToInt(displayFiatConversion))))
	}
}

//export callbackQmlBridgef074ca_AddTransactionToList
func callbackQmlBridgef074ca_AddTransactionToList(ptr unsafe.Pointer, paymentID C.struct_Moc_PackedString, transactionID C.struct_Moc_PackedString, amount C.struct_Moc_PackedString, confirmations C.struct_Moc_PackedString, ti C.struct_Moc_PackedString, number C.struct_Moc_PackedString) {
...
func (ptr *QmlBridge) ConnectAddTransactionToList(f func(paymentID string, transactionID string, amount string, confirmations string, ti string, number string)) {
	if ptr.Pointer() != nil {
		...
		if !qt.ExistsSignal(ptr.Pointer(), "addTransactionToList") {
			C.QmlBridgef074ca_ConnectAddTransactionToList(ptr.Pointer(), C.longlong(qt.ConnectionType(ptr.Pointer(), "addTransactionToList")))
		}
...
func (ptr *QmlBridge) DisconnectAddTransactionToList() {
	if ptr.Pointer() != nil {
		C.QmlBridgef074ca_DisconnectAddTransactionToList(ptr.Pointer())
...
func (ptr *QmlBridge) AddTransactionToList(paymentID string, transactionID string, amount string, confirmations string, ti string, number string) {
	if ptr.Pointer() != nil {
		...
		C.QmlBridgef074ca_AddTransactionToList(ptr.Pointer(), C.struct_Moc_PackedString{data: paymentIDC, len: C.longlong(len(paymentID))}, C.struct_Moc_PackedString{data: transactionIDC, len: C.longlong(len(transactionID))}, C.struct_Moc_PackedString{data: amountC, len: C.longlong(len(amount))}, C.struct_Moc_PackedString{data: confirmationsC, len: C.longlong(len(confirmations))}, C.struct_Moc_PackedString{data: tiC, len: C.longlong(len(ti))}, C.struct_Moc_PackedString{data: numberC, len: C.longlong(len(number))})
	}
}

//export callbackQmlBridgef074ca_AddRemoteNodeToList
func callbackQmlBridgef074ca_AddRemoteNodeToList(ptr unsafe.Pointer, nodeName C.struct_Moc_PackedString) {
...
func (ptr *QmlBridge) ConnectAddRemoteNodeToList(f func(nodeName string)) {
	if ptr.Pointer() != nil {
		...
		if !qt.ExistsSignal(ptr.Pointer(), "addRemoteNodeToList") {
			C.QmlBridgef074ca_ConnectAddRemoteNodeToList(ptr.Pointer(), C.longlong(qt.ConnectionType(ptr.Pointer(), "addRemoteNodeToList")))
		}
...
func (ptr *QmlBridge) DisconnectAddRemoteNodeToList() {
	if ptr.Pointer() != nil {
		C.QmlBridgef074ca_DisconnectAddRemoteNodeToList(ptr.Pointer())
...
func (ptr *QmlBridge) AddRemoteNodeToList(nodeName string) {
	if ptr.Pointer() != nil {
		...
		C.QmlBridgef074ca_AddRemoteNodeToList(ptr.Pointer(), C.struct_Moc_PackedString{data: nodeNameC, len: C.longlong(len(nodeName))})
	}
}

//export callbackQmlBridgef074ca_ChangeTextRemoteNode
func callbackQmlBridgef074ca_ChangeTextRemoteNode(ptr unsafe.Pointer, index C.int, newText C.struct_Moc_PackedString) {
...
func (ptr *QmlBridge) ConnectChangeTextRemoteNode(f func(index int, newText string)) {
	if ptr.Pointer() != nil {
		...
		if !qt.ExistsSignal(ptr.Pointer(), "changeTextRemoteNode") {
			C.QmlBridgef074ca_ConnectChangeTextRemoteNode(ptr.Pointer(), C.longlong(qt.ConnectionType(ptr.Pointer(), "changeTextRemoteNode")))
		}
...
func (ptr *QmlBridge) DisconnectChangeTextRemoteNode() {
	if ptr.Pointer() != nil {
		C.QmlBridgef074ca_DisconnectChangeTextRemoteNode(ptr.Pointer())
...
func (ptr *QmlBridge) ChangeTextRemoteNode(index int, newText string) {
	if ptr.Pointer() != nil {
		...
		C.QmlBridgef074ca_ChangeTextRemoteNode(ptr.Pointer(), C.int(int32(index)), C.struct_Moc_PackedString{data: newTextC, len: C.longlong(len(newText))})
	}
}

//export callbackQmlBridgef074ca_SetSelectedRemoteNode
func callbackQmlBridgef074ca_SetSelectedRemoteNode(ptr unsafe.Pointer, index C.int) {
...
func (ptr *QmlBridge) ConnectSetSelectedRemoteNode(f func(index int)) {
	if ptr.Pointer() != nil {
		...
		if !qt.ExistsSignal(ptr.Pointer(), "setSelectedRemoteNode") {
			C.QmlBridgef074ca_ConnectSetSelectedRemoteNode(ptr.Pointer(), C.longlong(qt.ConnectionType(ptr.Pointer(), "setSelectedRemoteNode")))
		}
...
func (ptr *QmlBridge) DisconnectSetSelectedRemoteNode() {
	if ptr.Pointer() != nil {
		C.QmlBridgef074ca_DisconnectSetSelectedRemoteNode(ptr.Pointer())
...
func (ptr *QmlBridge) SetSelectedRemoteNode(index int) {
	if ptr.Pointer() != nil {
		C.QmlBridgef074ca_SetSelectedRemoteNode(ptr.Pointer(), C.int(int32(index)))
	}
}

//export callbackQmlBridgef074ca_DisplayPopup
func callbackQmlBridgef074ca_DisplayPopup(ptr unsafe.Pointer, text C.struct_Moc_PackedString, ti C.int) {
...
func (ptr *QmlBridge) ConnectDisplayPopup(f func(text string, ti int)) {
	if ptr.Pointer() != nil {
		...
		if !qt.ExistsSignal(ptr.Pointer(), "displayPopup") {
			C.QmlBridgef074ca_ConnectDisplayPopup(ptr.Pointer(), C.longlong(qt.ConnectionType(ptr.Pointer(), "displayPopup")))
		}
...
func (ptr *QmlBridge) DisconnectDisplayPopup() {
	if ptr.Pointer() != nil {
		C.QmlBridgef074ca_DisconnectDisplayPopup(ptr.Pointer())
...
func (ptr *QmlBridge) DisplayPopup(text string, ti int) {
	if ptr.Pointer() != nil {
		...
		C.QmlBridgef074ca_DisplayPopup(ptr.Pointer(), C.struct_Moc_PackedString{data: textC, len: C.longlong(len(text))}, C.int(int32(ti)))
	}
}

//export callbackQmlBridgef074ca_DisplaySyncingInfo
func callbackQmlBridgef074ca_DisplaySyncingInfo(ptr unsafe.Pointer, syncing C.struct_Moc_PackedString, syncingInfo C.struct_Moc_PackedString) {
...
func (ptr *QmlBridge) ConnectDisplaySyncingInfo(f func(syncing string, syncingInfo string)) {
	if ptr.Pointer() != nil {
		...
		if !qt.ExistsSignal(ptr.Pointer(), "displaySyncingInfo") {
			C.QmlBridgef074ca_ConnectDisplaySyncingInfo(ptr.Pointer(), C.longlong(qt.ConnectionType(ptr.Pointer(), "displaySyncingInfo")))
		}
...
func (ptr *QmlBridge) DisconnectDisplaySyncingInfo() {
	if ptr.Pointer() != nil {
		C.QmlBridgef074ca_DisconnectDisplaySyncingInfo(ptr.Pointer())
...
func (ptr *QmlBridge) DisplaySyncingInfo(syncing string, syncingInfo string) {
	if ptr.Pointer() != nil {
		...
		C.QmlBridgef074ca_DisplaySyncingInfo(ptr.Pointer(), C.struct_Moc_PackedString{data: syncingC, len: C.longlong(len(syncing))}, C.struct_Moc_PackedString{data: syncingInfoC, len: C.longlong(len(syncingInfo))})
	}
}

//export callbackQmlBridgef074ca_DisplayErrorDialog
func callbackQmlBridgef074ca_DisplayErrorDialog(ptr unsafe.Pointer, errorText C.struct_Moc_PackedString, errorInformativeText C.struct_Moc_PackedString) {
...
func (ptr *QmlBridge) ConnectDisplayErrorDialog(f func(errorText string, errorInformativeText string)) {
	if ptr.Pointer() != nil {
		...
		if !qt.ExistsSignal(ptr.Pointer(), "displayErrorDialog") {
			C.QmlBridgef074ca_ConnectDisplayErrorDialog(ptr.Pointer(), C.longlong(qt.ConnectionType(ptr.Pointer(), "displayErrorDialog")))
		}
...
func (ptr *QmlBridge) DisconnectDisplayErrorDialog() {
	if ptr.Pointer() != nil {
		C.QmlBridgef074ca_DisconnectDisplayErrorDialog(ptr.Pointer())
...
func (ptr *QmlBridge) DisplayErrorDialog(errorText string, errorInformativeText string) {
	if ptr.Pointer() != nil {
		...
		C.QmlBridgef074ca_DisplayErrorDialog(ptr.Pointer(), C.struct_Moc_PackedString{data: errorTextC, len: C.longlong(len(errorText))}, C.struct_Moc_PackedString{data: errorInformativeTextC, len: C.longlong(len(errorInformativeText))})
	}
}

//export callbackQmlBridgef074ca_DisplayInfoDialog
func callbackQmlBridgef074ca_DisplayInfoDialog(ptr unsafe.Pointer, title C.struct_Moc_PackedString, mainText C.struct_Moc_PackedString, informativeText C.struct_Moc_PackedString) {
...
func (ptr *QmlBridge) ConnectDisplayInfoDialog(f func(title string, mainText string, informativeText string)) {
	if ptr.Pointer() != nil {
		...
		if !qt.ExistsSignal(ptr.Pointer(), "displayInfoDialog") {
			C.QmlBridgef074ca_ConnectDisplayInfoDialog(ptr.Pointer(), C.longlong(qt.ConnectionType(ptr.Pointer(), "displayInfoDialog")))
		}
...
func (ptr *QmlBridge) DisconnectDisplayInfoDialog() {
	if ptr.Pointer() != nil {
		C.QmlBridgef074ca_DisconnectDisplayInfoDialog(ptr.Pointer())
...
func (ptr *QmlBridge) DisplayInfoDialog(title string, mainText string, informativeText string) {
	if ptr.Pointer() != nil {
		...
		C.QmlBridgef074ca_DisplayInfoDialog(ptr.Pointer(), C.struct_Moc_PackedString{data: titleC, len: C.longlong(len(title))}, C.struct_Moc_PackedString{data: mainTextC, len: C.longlong(len(mainText))}, C.struct_Moc_PackedString{data: informativeTextC, len: C.longlong(len(informativeText))})
	}
}

//export callbackQmlBridgef074ca_ClearTransferAmount
func callbackQmlBridgef074ca_ClearTransferAmount(ptr unsafe.Pointer) {
...
func (ptr *QmlBridge) ConnectClearTransferAmount(f func()) {
	if ptr.Pointer() != nil {
		...
		if !qt.ExistsSignal(ptr.Pointer(), "clearTransferAmount") {
			C.QmlBridgef074ca_ConnectClearTransferAmount(ptr.Pointer(), C.longlong(qt.ConnectionType(ptr.Pointer(), "clearTransferAmount")))
		}
...
func (ptr *QmlBridge) DisconnectClearTransferAmount() {
	if ptr.Pointer() != nil {
		C.QmlBridgef074ca_DisconnectClearTransferAmount(ptr.Pointer())
...
func (ptr *QmlBridge) ClearTransferAmount() {
	if ptr.Pointer() != nil {
		C.QmlBridgef074ca_ClearTransferAmount(ptr.Pointer())
	}
}

//export callbackQmlBridgef074ca_AskForFusion
func callbackQmlBridgef074ca_AskForFusion(ptr unsafe.Pointer) {
...
func (ptr *QmlBridge) ConnectAskForFusion(f func()) {
	if ptr.Pointer() != nil {
		...
		if !qt.ExistsSignal(ptr.Pointer(), "askForFusion") {
			C.QmlBridgef074ca_ConnectAskForFusion(ptr.Pointer(), C.longlong(qt.ConnectionType(ptr.Pointer(), "askForFusion")))
		}
...
func (ptr *QmlBridge) DisconnectAskForFusion() {
	if ptr.Pointer() != nil {
		C.QmlBridgef074ca_DisconnectAskForFusion(ptr.Pointer())
...
func (ptr *QmlBridge) AskForFusion() {
	if ptr.Pointer() != nil {
		C.QmlBridgef074ca_AskForFusion(ptr.Pointer())
	}
}

//export callbackQmlBridgef074ca_ClearListTransactions
func callbackQmlBridgef074ca_ClearListTransactions(ptr unsafe.Pointer) {
...
func (ptr *QmlBridge) ConnectClearListTransactions(f func()) {
	if ptr.Pointer() != nil {
		...
		if !qt.ExistsSignal(ptr.Pointer(), "clearListTransactions") {
			C.QmlBridgef074ca_ConnectClearListTransactions(ptr.Pointer(), C.longlong(qt.ConnectionType(ptr.Pointer(), "clearListTransactions")))
		}
...
func (ptr *QmlBridge) DisconnectClearListTransactions() {
	if ptr.Pointer() != nil {
		C.QmlBridgef074ca_DisconnectClearListTransactions(ptr.Pointer())
...
func (ptr *QmlBridge) ClearListTransactions() {
	if ptr.Pointer() != nil {
		C.QmlBridgef074ca_ClearListTransactions(ptr.Pointer())
	}
}

//export callbackQmlBridgef074ca_DisplayPrivateKeys
func callbackQmlBridgef074ca_DisplayPrivateKeys(ptr unsafe.Pointer, filename C.struct_Moc_PackedString, privateViewKey C.struct_Moc_PackedString, privateSpendKey C.struct_Moc_PackedString, walletAddress C.struct_Moc_PackedString) {
...
func (ptr *QmlBridge) ConnectDisplayPrivateKeys(f func(filename string, privateViewKey string, privateSpendKey string, walletAddress string)) {
	if ptr.Pointer() != nil {
		...
		if !qt.ExistsSignal(ptr.Pointer(), "displayPrivateKeys") {
			C.QmlBridgef074ca_ConnectDisplayPrivateKeys(ptr.Pointer(), C.longlong(qt.ConnectionType(ptr.Pointer(), "displayPrivateKeys")))
		}
...
func (ptr *QmlBridge) DisconnectDisplayPrivateKeys() {
	if ptr.Pointer() != nil {
		C.QmlBridgef074ca_DisconnectDisplayPrivateKeys(ptr.Pointer())
...
func (ptr *QmlBridge) ConnectDisplaySeed(f func(filename string, mnemonicSeed string, walletAddress string)) {
	if ptr.Pointer() != nil {
		...
		if !qt.ExistsSignal(ptr.Pointer(), "displaySeed") {
			C.QmlBridgef074ca_ConnectDisplaySeed(ptr.Pointer(), C.longlong(qt.ConnectionType(ptr.Pointer(), "displaySeed")))
		}
...
func (ptr *QmlBridge) DisconnectDisplaySeed() {
	if ptr.Pointer() != nil {
		C.QmlBridgef074ca_DisconnectDisplaySeed(ptr.Pointer())
...
func (ptr *QmlBridge) DisplaySeed(filename string, mnemonicSeed string, walletAddress string) {
	if ptr.Pointer() != nil {
		...
		C.QmlBridgef074ca_DisplaySeed(ptr.Pointer(), C.struct_Moc_PackedString{data: filenameC, len: C.longlong(len(filename))}, C.struct_Moc_PackedString{data: mnemonicSeedC, len: C.longlong(len(mnemonicSeed))}, C.struct_Moc_PackedString{data: walletAddressC, len: C.longlong(len(walletAddress))})
	}
}

//export callbackQmlBridgef074ca_DisplayOpenWalletScreen
func callbackQmlBridgef074ca_DisplayOpenWalletScreen(ptr unsafe.Pointer) {
...
func (ptr *QmlBridge) ConnectDisplayOpenWalletScreen(f func()) {
	if ptr.Pointer() != nil {
		...
		if !qt.ExistsSignal(ptr.Pointer(), "displayOpenWalletScreen") {
			C.QmlBridgef074ca_ConnectDisplayOpenWalletScreen(ptr.Pointer(), C.longlong(qt.ConnectionType(ptr.Pointer(), "displayOpenWalletScreen")))
		}
...
func (ptr *QmlBridge) DisconnectDisplayOpenWalletScreen() {
	if ptr.Pointer() != nil {
		C.QmlBridgef074ca_DisconnectDisplayOpenWalletScreen(ptr.Pointer())
...
func (ptr *QmlBridge) DisplayOpenWalletScreen() {
	if ptr.Pointer() != nil {
		C.QmlBridgef074ca_DisplayOpenWalletScreen(ptr.Pointer())
	}
}

//export callbackQmlBridgef074ca_DisplayMainWalletScreen
func callbackQmlBridgef074ca_DisplayMainWalletScreen(ptr unsafe.Pointer) {
...
func (ptr *QmlBridge) ConnectDisplayMainWalletScreen(f func()) {
	if ptr.Pointer() != nil {
		...
		if !qt.ExistsSignal(ptr.Pointer(), "displayMainWalletScreen") {
			C.QmlBridgef074ca_ConnectDisplayMainWalletScreen(ptr.Pointer(), C.longlong(qt.ConnectionType(ptr.Pointer(), "displayMainWalletScreen")))
		}
...
func (ptr *QmlBridge) DisconnectDisplayMainWalletScreen() {
	if ptr.Pointer() != nil {
		C.QmlBridgef074ca_DisconnectDisplayMainWalletScreen(ptr.Pointer())
...
func (ptr *QmlBridge) DisplayMainWalletScreen() {
	if ptr.Pointer() != nil {
		C.QmlBridgef074ca_DisplayMainWalletScreen(ptr.Pointer())
	}
}

//export callbackQmlBridgef074ca_FinishedLoadingWalletd
func callbackQmlBridgef074ca_FinishedLoadingWalletd(ptr unsafe.Pointer) {
...
func (ptr *QmlBridge) ConnectFinishedLoadingWalletd(f func()) {
	if ptr.Pointer() != nil {
		...
		if !qt.ExistsSignal(ptr.Pointer(), "finishedLoadingWalletd") {
			C.QmlBridgef074ca_ConnectFinishedLoadingWalletd(ptr.Pointer(), C.longlong(qt.ConnectionType(ptr.Pointer(), "finishedLoadingWalletd")))
		}
...
func (ptr *QmlBridge) DisconnectFinishedLoadingWalletd() {
	if ptr.Pointer() != nil {
		C.QmlBridgef074ca_DisconnectFinishedLoadingWalletd(ptr.Pointer())
...
func (ptr *QmlBridge) FinishedLoadingWalletd() {
	if ptr.Pointer() != nil {
		C.QmlBridgef074ca_FinishedLoadingWalletd(ptr.Pointer())
	}
}

//export callbackQmlBridgef074ca_FinishedCreatingWallet
func callbackQmlBridgef074ca_FinishedCreatingWallet(ptr unsafe.Pointer) {
...
func (ptr *QmlBridge) ConnectFinishedCreatingWallet(f func()) {
	if ptr.Pointer() != nil {
		...
		if !qt.ExistsSignal(ptr.Pointer(), "finishedCreatingWallet") {
			C.QmlBridgef074ca_ConnectFinishedCreatingWallet(ptr.Pointer(), C.longlong(qt.ConnectionType(ptr.Pointer(), "finishedCreatingWallet")))
		}
...
func (ptr *QmlBridge) DisconnectFinishedCreatingWallet() {
	if ptr.Pointer() != nil {
		C.QmlBridgef074ca_DisconnectFinishedCreatingWallet(ptr.Pointer())
...
func (ptr *QmlBridge) FinishedCreatingWallet() {
	if ptr.Pointer() != nil {
		C.QmlBridgef074ca_FinishedCreatingWallet(ptr.Pointer())
	}
}

//export callbackQmlBridgef074ca_FinishedSendingTransaction
func callbackQmlBridgef074ca_FinishedSendingTransaction(ptr unsafe.Pointer) {
...
func (ptr *QmlBridge) ConnectFinishedSendingTransaction(f func()) {
	if ptr.Pointer() != nil {
		...
		if !qt.ExistsSignal(ptr.Pointer(), "finishedSendingTransaction") {
			C.QmlBridgef074ca_ConnectFinishedSendingTransaction(ptr.Pointer(), C.longlong(qt.ConnectionType(ptr.Pointer(), "finishedSendingTransaction")))
		}
...
func (ptr *QmlBridge) DisconnectFinishedSendingTransaction() {
	if ptr.Pointer() != nil {
		C.QmlBridgef074ca_DisconnectFinishedSendingTransaction(ptr.Pointer())
...
func (ptr *QmlBridge) FinishedSendingTransaction() {
	if ptr.Pointer() != nil {
		C.QmlBridgef074ca_FinishedSendingTransaction(ptr.Pointer())
	}
}

//export callbackQmlBridgef074ca_DisplayPathToPreviousWallet
func callbackQmlBridgef074ca_DisplayPathToPreviousWallet(ptr unsafe.Pointer, pathToPreviousWallet C.struct_Moc_PackedString) {
...
func (ptr *QmlBridge) ConnectDisplayPathToPreviousWallet(f func(pathToPreviousWallet string)) {
	if ptr.Pointer() != nil {
		...
		if !qt.ExistsSignal(ptr.Pointer(), "displayPathToPreviousWallet") {
			C.QmlBridgef074ca_ConnectDisplayPathToPreviousWallet(ptr.Pointer(), C.longlong(qt.ConnectionType(ptr.Pointer(), "displayPathToPreviousWallet")))
		}
...
func (ptr *QmlBridge) DisconnectDisplayPathToPreviousWallet() {
	if ptr.Pointer() != nil {
		C.QmlBridgef074ca_DisconnectDisplayPathToPreviousWallet(ptr.Pointer())
...
func (ptr *QmlBridge) DisplayPathToPreviousWallet(pathToPreviousWallet string) {
	if ptr.Pointer() != nil {
		...
		C.QmlBridgef074ca_DisplayPathToPreviousWallet(ptr.Pointer(), C.struct_Moc_PackedString{data: pathToPreviousWalletC, len: C.longlong(len(pathToPreviousWallet))})
	}
}

//export callbackQmlBridgef074ca_DisplayWalletCreationLocation
func callbackQmlBridgef074ca_DisplayWalletCreationLocation(ptr unsafe.Pointer, walletLocation C.struct_Moc_PackedString) {
...
func (ptr *QmlBridge) ConnectDisplayWalletCreationLocation(f func(walletLocation string)) {
	if ptr.Pointer() != nil {
		...
		if !qt.ExistsSignal(ptr.Pointer(), "displayWalletCreationLocation") {
			C.QmlBridgef074ca_ConnectDisplayWalletCreationLocation(ptr.Pointer(), C.longlong(qt.ConnectionType(ptr.Pointer(), "displayWalletCreationLocation")))
		}
...
func (ptr *QmlBridge) DisconnectDisplayWalletCreationLocation() {
	if ptr.Pointer() != nil {
		C.QmlBridgef074ca_DisconnectDisplayWalletCreationLocation(ptr.Pointer())
...
func (ptr *QmlBridge) DisplayWalletCreationLocation(walletLocation string) {
	if ptr.Pointer() != nil {
		...
		C.QmlBridgef074ca_DisplayWalletCreationLocation(ptr.Pointer(), C.struct_Moc_PackedString{data: walletLocationC, len: C.longlong(len(walletLocation))})
	}
}

//export callbackQmlBridgef074ca_DisplayUseRemoteNode
func callbackQmlBridgef074ca_DisplayUseRemoteNode(ptr unsafe.Pointer, useRemote C.char) {
...
func (ptr *QmlBridge) ConnectDisplayUseRemoteNode(f func(useRemote bool)) {
	if ptr.Pointer() != nil {
		...
		if !qt.ExistsSignal(ptr.Pointer(), "displayUseRemoteNode") {
			C.QmlBridgef074ca_ConnectDisplayUseRemoteNode(ptr.Pointer(), C.longlong(qt.ConnectionType(ptr.Pointer(), "displayUseRemoteNode")))
		}
...
func (ptr *QmlBridge) DisconnectDisplayUseRemoteNode() {
	if ptr.Pointer() != nil {
		C.QmlBridgef074ca_DisconnectDisplayUseRemoteNode(ptr.Pointer())
...
func (ptr *QmlBridge) DisplayUseRemoteNode(useRemote bool) {
	if ptr.Pointer() != nil {
		C.QmlBridgef074ca_DisplayUseRemoteNode(ptr.Pointer(), C.char(int8(qt.GoBoolToInt(useRemote))))
	}
}

//export callbackQmlBridgef074ca_HideSettingsScreen
func callbackQmlBridgef074ca_HideSettingsScreen(ptr unsafe.Pointer) {
...
func (ptr *QmlBridge) ConnectHideSettingsScreen(f func()) {
	if ptr.Pointer() != nil {
		...
		if !qt.ExistsSignal(ptr.Pointer(), "hideSettingsScreen") {
			C.QmlBridgef074ca_ConnectHideSettingsScreen(ptr.Pointer(), C.longlong(qt.ConnectionType(ptr.Pointer(), "hideSettingsScreen")))
		}
...
func (ptr *QmlBridge) DisconnectHideSettingsScreen() {
	if ptr.Pointer() != nil {
		C.QmlBridgef074ca_DisconnectHideSettingsScreen(ptr.Pointer())
...
func (ptr *QmlBridge) HideSettingsScreen() {
	if ptr.Pointer() != nil {
		C.QmlBridgef074ca_HideSettingsScreen(ptr.Pointer())
	}
}

//export callbackQmlBridgef074ca_DisplaySettingsScreen
func callbackQmlBridgef074ca_DisplaySettingsScreen(ptr unsafe.Pointer) {
...
func (ptr *QmlBridge) ConnectDisplaySettingsScreen(f func()) {
	if ptr.Pointer() != nil {
		...
		if !qt.ExistsSignal(ptr.Pointer(), "displaySettingsScreen") {
			C.QmlBridgef074ca_ConnectDisplaySettingsScreen(ptr.Pointer(), C.longlong(qt.ConnectionType(ptr.Pointer(), "displaySettingsScreen")))
		}
...
func (ptr *QmlBridge) DisconnectDisplaySettingsScreen() {
	if ptr.Pointer() != nil {
		C.QmlBridgef074ca_DisconnectDisplaySettingsScreen(ptr.Pointer())
...
func (ptr *QmlBridge) DisplaySettingsScreen() {
	if ptr.Pointer() != nil {
		C.QmlBridgef074ca_DisplaySettingsScreen(ptr.Pointer())
	}
}

//export callbackQmlBridgef074ca_DisplaySettingsValues
func callbackQmlBridgef074ca_DisplaySettingsValues(ptr unsafe.Pointer, displayFiat C.char) {
...
func (ptr *QmlBridge) ConnectDisplaySettingsValues(f func(displayFiat bool)) {
	if ptr.Pointer() != nil {
		...
		if !qt.ExistsSignal(ptr.Pointer(), "displaySettingsValues") {
			C.QmlBridgef074ca_ConnectDisplaySettingsValues(ptr.Pointer(), C.longlong(qt.ConnectionType(ptr.Pointer(), "displaySettingsValues")))
		}
...
func (ptr *QmlBridge) DisconnectDisplaySettingsValues() {
	if ptr.Pointer() != nil {
		C.QmlBridgef074ca_DisconnectDisplaySettingsValues(ptr.Pointer())
...
func (ptr *QmlBridge) DisplaySettingsValues(displayFiat bool) {
	if ptr.Pointer() != nil {
		C.QmlBridgef074ca_DisplaySettingsValues(ptr.Pointer(), C.char(int8(qt.GoBoolToInt(displayFiat))))
	}
}

//export callbackQmlBridgef074ca_DisplaySettingsRemoteDaemonInfo
func callbackQmlBridgef074ca_DisplaySettingsRemoteDaemonInfo(ptr unsafe.Pointer, remoteNodeAddress C.struct_Moc_PackedString, remoteNodePort C.struct_Moc_PackedString) {
...
func (ptr *QmlBridge) ConnectDisplaySettingsRemoteDaemonInfo(f func(remoteNodeAddress string, remoteNodePort string)) {
	if ptr.Pointer() != nil {
		...
		if !qt.ExistsSignal(ptr.Pointer(), "displaySettingsRemoteDaemonInfo") {
			C.QmlBridgef074ca_ConnectDisplaySettingsRemoteDaemonInfo(ptr.Pointer(), C.longlong(qt.ConnectionType(ptr.Pointer(), "displaySettingsRemoteDaemonInfo")))
		}
...
func (ptr *QmlBridge) DisconnectDisplaySettingsRemoteDaemonInfo() {
	if ptr.Pointer() != nil {
		C.QmlBridgef074ca_DisconnectDisplaySettingsRemoteDaemonInfo(ptr.Pointer())
...
func (ptr *QmlBridge) DisplaySettingsRemoteDaemonInfo(remoteNodeAddress string, remoteNodePort string) {
	if ptr.Pointer() != nil {
		...
		C.QmlBridgef074ca_DisplaySettingsRemoteDaemonInfo(ptr.Pointer(), C.struct_Moc_PackedString{data: remoteNodeAddressC, len: C.longlong(len(remoteNodeAddress))}, C.struct_Moc_PackedString{data: remoteNodePortC, len: C.longlong(len(remoteNodePort))})
	}
}

//export callbackQmlBridgef074ca_DisplayFullBalanceInTransferAmount
func callbackQmlBridgef074ca_DisplayFullBalanceInTransferAmount(ptr unsafe.Pointer, fullBalance C.struct_Moc_PackedString) {
...
func (ptr *QmlBridge) ConnectDisplayFullBalanceInTransferAmount(f func(fullBalance string)) {
	if ptr.Pointer() != nil {
		...
		if !qt.ExistsSignal(ptr.Pointer(), "displayFullBalanceInTransferAmount") {
			C.QmlBridgef074ca_ConnectDisplayFullBalanceInTransferAmount(ptr.Pointer(), C.longlong(qt.ConnectionType(ptr.Pointer(), "displayFullBalanceInTransferAmount")))
		}
...
func (ptr *QmlBridge) DisconnectDisplayFullBalanceInTransferAmount() {
	if ptr.Pointer() != nil {
		C.QmlBridgef074ca_DisconnectDisplayFullBalanceInTransferAmount(ptr.Pointer())
...
func (ptr *QmlBridge) DisplayFullBalanceInTransferAmount(fullBalance string) {
	if ptr.Pointer() != nil {
		...
		C.QmlBridgef074ca_DisplayFullBalanceInTransferAmount(ptr.Pointer(), C.struct_Moc_PackedString{data: fullBalanceC, len: C.longlong(len(fullBalance))})
	}
}

//export callbackQmlBridgef074ca_DisplayDefaultFee
func callbackQmlBridgef074ca_DisplayDefaultFee(ptr unsafe.Pointer, fee C.struct_Moc_PackedString) {
...
func (ptr *QmlBridge) ConnectDisplayDefaultFee(f func(fee string)) {
	if ptr.Pointer() != nil {
		...
		if !qt.ExistsSignal(ptr.Pointer(), "displayDefaultFee") {
			C.QmlBridgef074ca_ConnectDisplayDefaultFee(ptr.Pointer(), C.longlong(qt.ConnectionType(ptr.Pointer(), "displayDefaultFee")))
		}
...
func (ptr *QmlBridge) DisconnectDisplayDefaultFee() {
	if ptr.Pointer() != nil {
		C.QmlBridgef074ca_DisconnectDisplayDefaultFee(ptr.Pointer())
...
func (ptr *QmlBridge) DisplayDefaultFee(fee string) {
	if ptr.Pointer() != nil {
		...
		C.QmlBridgef074ca_DisplayDefaultFee(ptr.Pointer(), C.struct_Moc_PackedString{data: feeC, len: C.longlong(len(fee))})
	}
}

//export callbackQmlBridgef074ca_DisplayNodeFee
func callbackQmlBridgef074ca_DisplayNodeFee(ptr unsafe.Pointer, nodeFee C.struct_Moc_PackedString) {
...
func (ptr *QmlBridge) ConnectDisplayNodeFee(f func(nodeFee string)) {
	if ptr.Pointer() != nil {
		...
		if !qt.ExistsSignal(ptr.Pointer(), "displayNodeFee") {
			C.QmlBridgef074ca_ConnectDisplayNodeFee(ptr.Pointer(), C.longlong(qt.ConnectionType(ptr.Pointer(), "displayNodeFee")))
		}
...
func (ptr *QmlBridge) DisconnectDisplayNodeFee() {
	if ptr.Pointer() != nil {
		C.QmlBridgef074ca_DisconnectDisplayNodeFee(ptr.Pointer())
...
func (ptr *QmlBridge) DisplayNodeFee(nodeFee string) {
	if ptr.Pointer() != nil {
		...
		C.QmlBridgef074ca_DisplayNodeFee(ptr.Pointer(), C.struct_Moc_PackedString{data: nodeFeeC, len: C.longlong(len(nodeFee))})
	}
}

//export callbackQmlBridgef074ca_UpdateConfirmationsOfTransaction
func callbackQmlBridgef074ca_UpdateConfirmationsOfTransaction(ptr unsafe.Pointer, index C.int, confirmations C.struct_Moc_PackedString) {
...
func (ptr *QmlBridge) ConnectUpdateConfirmationsOfTransaction(f func(index int, confirmations string)) {
	if ptr.Pointer() != nil {
		...
		if !qt.ExistsSignal(ptr.Pointer(), "updateConfirmationsOfTransaction") {
			C.QmlBridgef074ca_ConnectUpdateConfirmationsOfTransaction(ptr.Pointer(), C.longlong(qt.ConnectionType(ptr.Pointer(), "updateConfirmationsOfTransaction")))
		}
...
func (ptr *QmlBridge) DisconnectUpdateConfirmationsOfTransaction() {
	if ptr.Pointer() != nil {
		C.QmlBridgef074ca_DisconnectUpdateConfirmationsOfTransaction(ptr.Pointer())
...
func (ptr *QmlBridge) UpdateConfirmationsOfTransaction(index int, confirmations string) {
	if ptr.Pointer() != nil {
		...
		C.QmlBridgef074ca_UpdateConfirmationsOfTransaction(ptr.Pointer(), C.int(int32(index)), C.struct_Moc_PackedString{data: confirmationsC, len: C.longlong(len(confirmations))})
	}
}

//export callbackQmlBridgef074ca_DisplayInfoScreen
func callbackQmlBridgef074ca_DisplayInfoScreen(ptr unsafe.Pointer) {
...
func (ptr *QmlBridge) ConnectDisplayInfoScreen(f func()) {
	if ptr.Pointer() != nil {
		...
		if !qt.ExistsSignal(ptr.Pointer(), "displayInfoScreen") {
			C.QmlBridgef074ca_ConnectDisplayInfoScreen(ptr.Pointer(), C.longlong(qt.ConnectionType(ptr.Pointer(), "displayInfoScreen")))
		}
...
func (ptr *QmlBridge) DisconnectDisplayInfoScreen() {
	if ptr.Pointer() != nil {
		C.QmlBridgef074ca_DisconnectDisplayInfoScreen(ptr.Pointer())
...
func (ptr *QmlBridge) DisplayInfoScreen() {
	if ptr.Pointer() != nil {
		C.QmlBridgef074ca_DisplayInfoScreen(ptr.Pointer())
	}
}

//export callbackQmlBridgef074ca_AddSavedAddressToList
func callbackQmlBridgef074ca_AddSavedAddressToList(ptr unsafe.Pointer, dbID C.int, name C.struct_Moc_PackedString, address C.struct_Moc_PackedString, paymentID C.struct_Moc_PackedString) {
...
func (ptr *QmlBridge) ConnectAddSavedAddressToList(f func(dbID int, name string, address string, paymentID string)) {
	if ptr.Pointer() != nil {
		...
		if !qt.ExistsSignal(ptr.Pointer(), "addSavedAddressToList") {
			C.QmlBridgef074ca_ConnectAddSavedAddressToList(ptr.Pointer(), C.longlong(qt.ConnectionType(ptr.Pointer(), "addSavedAddressToList")))
		}
...
func (ptr *QmlBridge) DisconnectAddSavedAddressToList() {
	if ptr.Pointer() != nil {
		C.QmlBridgef074ca_DisconnectAddSavedAddressToList(ptr.Pointer())
...
func (ptr *QmlBridge) AddSavedAddressToList(dbID int, name string, address string, paymentID string) {
	if ptr.Pointer() != nil {
		...
		C.QmlBridgef074ca_AddSavedAddressToList(ptr.Pointer(), C.int(int32(dbID)), C.struct_Moc_PackedString{data: nameC, len: C.longlong(len(name))}, C.struct_Moc_PackedString{data: addressC, len: C.longlong(len(address))}, C.struct_Moc_PackedString{data: paymentIDC, len: C.longlong(len(paymentID))})
	}
}

//export callbackQmlBridgef074ca_Log
func callbackQmlBridgef074ca_Log(ptr unsafe.Pointer, msg C.struct_Moc_PackedString) {
...
func (ptr *QmlBridge) Log(msg string) {
	if ptr.Pointer() != nil {
		...
		C.QmlBridgef074ca_Log(ptr.Pointer(), C.struct_Moc_PackedString{data: msgC, len: C.longlong(len(msg))})
	}
}

//export callbackQmlBridgef074ca_ClickedButtonExplorer
func callbackQmlBridgef074ca_ClickedButtonExplorer(ptr unsafe.Pointer, transactionID C.struct_Moc_PackedString) {
...
func (ptr *QmlBridge) ClickedButtonExplorer(transactionID string) {
	if ptr.Pointer() != nil {
		...
		C.QmlBridgef074ca_ClickedButtonExplorer(ptr.Pointer(), C.struct_Moc_PackedString{data: transactionIDC, len: C.longlong(len(transactionID))})
	}
}

//export callbackQmlBridgef074ca_GoToWebsite
func callbackQmlBridgef074ca_GoToWebsite(ptr unsafe.Pointer, url C.struct_Moc_PackedString) {
...
func (ptr *QmlBridge) GoToWebsite(url string) {
	if ptr.Pointer() != nil {
		...
		C.QmlBridgef074ca_GoToWebsite(ptr.Pointer(), C.struct_Moc_PackedString{data: urlC, len: C.longlong(len(url))})
	}
}

//export callbackQmlBridgef074ca_ClickedButtonCopyTx
func callbackQmlBridgef074ca_ClickedButtonCopyTx(ptr unsafe.Pointer, transactionID C.struct_Moc_PackedString) {
...
func (ptr *QmlBridge) ClickedButtonCopyTx(transactionID string) {
	if ptr.Pointer() != nil {
		...
		C.QmlBridgef074ca_ClickedButtonCopyTx(ptr.Pointer(), C.struct_Moc_PackedString{data: transactionIDC, len: C.longlong(len(transactionID))})
	}
}

//export callbackQmlBridgef074ca_ClickedButtonCopyAddress
func callbackQmlBridgef074ca_ClickedButtonCopyAddress(ptr unsafe.Pointer) {
...
func (ptr *QmlBridge) ClickedButtonCopyAddress() {
	if ptr.Pointer() != nil {
		C.QmlBridgef074ca_ClickedButtonCopyAddress(ptr.Pointer())
	}
}

//export callbackQmlBridgef074ca_ClickedButtonCopyKeys
func callbackQmlBridgef074ca_ClickedButtonCopyKeys(ptr unsafe.Pointer) {
...
func (ptr *QmlBridge) ClickedButtonCopyKeys() {
	if ptr.Pointer() != nil {
		C.QmlBridgef074ca_ClickedButtonCopyKeys(ptr.Pointer())
	}
}

//export callbackQmlBridgef074ca_ClickedButtonCopy
func callbackQmlBridgef074ca_ClickedButtonCopy(ptr unsafe.Pointer, stringToCopy C.struct_Moc_PackedString) {
...
func (ptr *QmlBridge) ClickedButtonCopy(stringToCopy string) {
	if ptr.Pointer() != nil {
		...
		C.QmlBridgef074ca_ClickedButtonCopy(ptr.Pointer(), C.struct_Moc_PackedString{data: stringToCopyC, len: C.longlong(len(stringToCopy))})
	}
}

//export callbackQmlBridgef074ca_ClickedButtonSend
func callbackQmlBridgef074ca_ClickedButtonSend(ptr unsafe.Pointer, transferAddress C.struct_Moc_PackedString, transferAmount C.struct_Moc_PackedString, transferPaymentID C.struct_Moc_PackedString, transferFee C.struct_Moc_PackedString) {
...
func (ptr *QmlBridge) ClickedButtonSend(transferAddress string, transferAmount string, transferPaymentID string, transferFee string) {
	if ptr.Pointer() != nil {
		...
		C.QmlBridgef074ca_ClickedButtonSend(ptr.Pointer(), C.struct_Moc_PackedString{data: transferAddressC, len: C.longlong(len(transferAddress))}, C.struct_Moc_PackedString{data: transferAmountC, len: C.longlong(len(transferAmount))}, C.struct_Moc_PackedString{data: transferPaymentIDC, len: C.longlong(len(transferPaymentID))}, C.struct_Moc_PackedString{data: transferFeeC, len: C.longlong(len(transferFee))})
	}
}

//export callbackQmlBridgef074ca_ClickedButtonBackupWallet
func callbackQmlBridgef074ca_ClickedButtonBackupWallet(ptr unsafe.Pointer) {
...
func (ptr *QmlBridge) ClickedButtonBackupWallet() {
	if ptr.Pointer() != nil {
		C.QmlBridgef074ca_ClickedButtonBackupWallet(ptr.Pointer())
	}
}

//export callbackQmlBridgef074ca_ClickedCloseWallet
func callbackQmlBridgef074ca_ClickedCloseWallet(ptr unsafe.Pointer) {
...
func (ptr *QmlBridge) ClickedCloseWallet() {
	if ptr.Pointer() != nil {
		C.QmlBridgef074ca_ClickedCloseWallet(ptr.Pointer())
	}
}

//export callbackQmlBridgef074ca_ClickedButtonOpen
func callbackQmlBridgef074ca_ClickedButtonOpen(ptr unsafe.Pointer, pathToWallet C.struct_Moc_PackedString, passwordWallet C.struct_Moc_PackedString) {
...
func (ptr *QmlBridge) ClickedButtonOpen(pathToWallet string, passwordWallet string) {
	if ptr.Pointer() != nil {
		...
		C.QmlBridgef074ca_ClickedButtonOpen(ptr.Pointer(), C.struct_Moc_PackedString{data: pathToWalletC, len: C.longlong(len(pathToWallet))}, C.struct_Moc_PackedString{data: passwordWalletC, len: C.longlong(len(passwordWallet))})
	}
}

//export callbackQmlBridgef074ca_ClickedButtonCreate
func callbackQmlBridgef074ca_ClickedButtonCreate(ptr unsafe.Pointer, filenameWallet C.struct_Moc_PackedString, passwordWallet C.struct_Moc_PackedString, confirmPasswordWallet C.struct_Moc_PackedString) {
...
func (ptr *QmlBridge) ClickedButtonCreate(filenameWallet string, passwordWallet string, confirmPasswordWallet string) {
	if ptr.Pointer() != nil {
		...
		C.QmlBridgef074ca_ClickedButtonCreate(ptr.Pointer(), C.struct_Moc_PackedString{data: filenameWalletC, len: C.longlong(len(filenameWallet))}, C.struct_Moc_PackedString{data: passwordWalletC, len: C.longlong(len(passwordWallet))}, C.struct_Moc_PackedString{data: confirmPasswordWalletC, len: C.longlong(len(confirmPasswordWallet))})
	}
}

//export callbackQmlBridgef074ca_ClickedButtonImport
func callbackQmlBridgef074ca_ClickedButtonImport(ptr unsafe.Pointer, filenameWallet C.struct_Moc_PackedString, passwordWallet C.struct_Moc_PackedString, privateViewKey C.struct_Moc_PackedString, privateSpendKey C.struct_Moc_PackedString, mnemonicSeed C.struct_Moc_PackedString, confirmPasswordWallet C.struct_Moc_PackedString, scanHeight C.struct_Moc_PackedString) {
...
func (ptr *QmlBridge) ChoseRemote(remote bool) {
	if ptr.Pointer() != nil {
		C.QmlBridgef074ca_ChoseRemote(ptr.Pointer(), C.char(int8(qt.GoBoolToInt(remote))))
	}
}

//export callbackQmlBridgef074ca_SelectedRemoteNode
func callbackQmlBridgef074ca_SelectedRemoteNode(ptr unsafe.Pointer, index C.int) {
...
func (ptr *QmlBridge) SelectedRemoteNode(index int) {
	if ptr.Pointer() != nil {
		C.QmlBridgef074ca_SelectedRemoteNode(ptr.Pointer(), C.int(int32(index)))
	}
}

//export callbackQmlBridgef074ca_GetTransferAmountUSD
func callbackQmlBridgef074ca_GetTransferAmountUSD(ptr unsafe.Pointer, amountTRTL C.struct_Moc_PackedString) C.struct_Moc_PackedString {
...
func (ptr *QmlBridge) GetTransferAmountUSD(amountTRTL string) string {
	if ptr.Pointer() != nil {
		...
		return cGoUnpackString(C.QmlBridgef074ca_GetTransferAmountUSD(ptr.Pointer(), C.struct_Moc_PackedString{data: amountTRTLC, len: C.longlong(len(amountTRTL))}))
	}
	return ""
}

//export callbackQmlBridgef074ca_ClickedCloseSettings
func callbackQmlBridgef074ca_ClickedCloseSettings(ptr unsafe.Pointer) {
...
func (ptr *QmlBridge) ClickedCloseSettings() {
	if ptr.Pointer() != nil {
		C.QmlBridgef074ca_ClickedCloseSettings(ptr.Pointer())
	}
}

//export callbackQmlBridgef074ca_ClickedSettingsButton
func callbackQmlBridgef074ca_ClickedSettingsButton(ptr unsafe.Pointer) {
...
func (ptr *QmlBridge) ClickedSettingsButton() {
	if ptr.Pointer() != nil {
		C.QmlBridgef074ca_ClickedSettingsButton(ptr.Pointer())
	}
}

//export callbackQmlBridgef074ca_ChoseDisplayFiat
func callbackQmlBridgef074ca_ChoseDisplayFiat(ptr unsafe.Pointer, displayFiat C.char) {
...
func (ptr *QmlBridge) ChoseDisplayFiat(displayFiat bool) {
	if ptr.Pointer() != nil {
		C.QmlBridgef074ca_ChoseDisplayFiat(ptr.Pointer(), C.char(int8(qt.GoBoolToInt(displayFiat))))
	}
}

//export callbackQmlBridgef074ca_ChoseCheckpoints
func callbackQmlBridgef074ca_ChoseCheckpoints(ptr unsafe.Pointer, checkpoints C.char) {
...
func (ptr *QmlBridge) ChoseCheckpoints(checkpoints bool) {
	if ptr.Pointer() != nil {
		C.QmlBridgef074ca_ChoseCheckpoints(ptr.Pointer(), C.char(int8(qt.GoBoolToInt(checkpoints))))
	}
}

//export callbackQmlBridgef074ca_SaveRemoteDaemonInfo
func callbackQmlBridgef074ca_SaveRemoteDaemonInfo(ptr unsafe.Pointer, daemonAddress C.struct_Moc_PackedString, daemonPort C.struct_Moc_PackedString) {
...
func (ptr *QmlBridge) SaveRemoteDaemonInfo(daemonAddress string, daemonPort string) {
	if ptr.Pointer() != nil {
		...
		C.QmlBridgef074ca_SaveRemoteDaemonInfo(ptr.Pointer(), C.struct_Moc_PackedString{data: daemonAddressC, len: C.longlong(len(daemonAddress))}, C.struct_Moc_PackedString{data: daemonPortC, len: C.longlong(len(daemonPort))})
	}
}

//export callbackQmlBridgef074ca_ResetRemoteDaemonInfo
func callbackQmlBridgef074ca_ResetRemoteDaemonInfo(ptr unsafe.Pointer) {
...
func (ptr *QmlBridge) ResetRemoteDaemonInfo() {
	if ptr.Pointer() != nil {
		C.QmlBridgef074ca_ResetRemoteDaemonInfo(ptr.Pointer())
	}
}

//export callbackQmlBridgef074ca_GetFullBalanceAndDisplayInTransferAmount
func callbackQmlBridgef074ca_GetFullBalanceAndDisplayInTransferAmount(ptr unsafe.Pointer, transferFee C.struct_Moc_PackedString) {
...
func (ptr *QmlBridge) GetFullBalanceAndDisplayInTransferAmount(transferFee string) {
	if ptr.Pointer() != nil {
		...
		C.QmlBridgef074ca_GetFullBalanceAndDisplayInTransferAmount(ptr.Pointer(), C.struct_Moc_PackedString{data: transferFeeC, len: C.longlong(len(transferFee))})
	}
}

//export callbackQmlBridgef074ca_GetDefaultFeeAndDisplay
func callbackQmlBridgef074ca_GetDefaultFeeAndDisplay(ptr unsafe.Pointer) {
...
func (ptr *QmlBridge) GetDefaultFeeAndDisplay() {
	if ptr.Pointer() != nil {
		C.QmlBridgef074ca_GetDefaultFeeAndDisplay(ptr.Pointer())
	}
}

//export callbackQmlBridgef074ca_LimitDisplayTransactions
func callbackQmlBridgef074ca_LimitDisplayTransactions(ptr unsafe.Pointer, limit C.char) {
...
func (ptr *QmlBridge) LimitDisplayTransactions(limit bool) {
	if ptr.Pointer() != nil {
		C.QmlBridgef074ca_LimitDisplayTransactions(ptr.Pointer(), C.char(int8(qt.GoBoolToInt(limit))))
	}
}

//export callbackQmlBridgef074ca_GetVersion
func callbackQmlBridgef074ca_GetVersion(ptr unsafe.Pointer) C.struct_Moc_PackedString {
...
func (ptr *QmlBridge) GetVersion() string {
	if ptr.Pointer() != nil {
		return cGoUnpackString(C.QmlBridgef074ca_GetVersion(ptr.Pointer()))
	}
	return ""
}

//export callbackQmlBridgef074ca_GetNewVersion
func callbackQmlBridgef074ca_GetNewVersion(ptr unsafe.Pointer) C.struct_Moc_PackedString {
...
func (ptr *QmlBridge) GetNewVersion() string {
	if ptr.Pointer() != nil {
		return cGoUnpackString(C.QmlBridgef074ca_GetNewVersion(ptr.Pointer()))
	}
	return ""
}

//export callbackQmlBridgef074ca_GetNewVersionURL
func callbackQmlBridgef074ca_GetNewVersionURL(ptr unsafe.Pointer) C.struct_Moc_PackedString {
...
func (ptr *QmlBridge) GetNewVersionURL() string {
	if ptr.Pointer() != nil {
		return cGoUnpackString(C.QmlBridgef074ca_GetNewVersionURL(ptr.Pointer()))
	}
	return ""
}

//export callbackQmlBridgef074ca_OptimizeWalletWithFusion
func callbackQmlBridgef074ca_OptimizeWalletWithFusion(ptr unsafe.Pointer) {
...
func (ptr *QmlBridge) OptimizeWalletWithFusion() {
	if ptr.Pointer() != nil {
		C.QmlBridgef074ca_OptimizeWalletWithFusion(ptr.Pointer())
	}
}

//export callbackQmlBridgef074ca_SaveAddress
func callbackQmlBridgef074ca_SaveAddress(ptr unsafe.Pointer, name C.struct_Moc_PackedString, address C.struct_Moc_PackedString, paymentID C.struct_Moc_PackedString) {
...
func (ptr *QmlBridge) SaveAddress(name string, address string, paymentID string) {
	if ptr.Pointer() != nil {
		...
		C.QmlBridgef074ca_SaveAddress(ptr.Pointer(), C.struct_Moc_PackedString{data: nameC, len: C.longlong(len(name))}, C.struct_Moc_PackedString{data: addressC, len: C.longlong(len(address))}, C.struct_Moc_PackedString{data: paymentIDC, len: C.longlong(len(paymentID))})
	}
}

//export callbackQmlBridgef074ca_FillListSavedAddresses
func callbackQmlBridgef074ca_FillListSavedAddresses(ptr unsafe.Pointer) {
...
func (ptr *QmlBridge) FillListSavedAddresses() {
	if ptr.Pointer() != nil {
		C.QmlBridgef074ca_FillListSavedAddresses(ptr.Pointer())
	}
}

//export callbackQmlBridgef074ca_DeleteSavedAddress
func callbackQmlBridgef074ca_DeleteSavedAddress(ptr unsafe.Pointer, dbID C.int) {
...
func (ptr *QmlBridge) DeleteSavedAddress(dbID int) {
	if ptr.Pointer() != nil {
		C.QmlBridgef074ca_DeleteSavedAddress(ptr.Pointer(), C.int(int32(dbID)))
	}
}

//export callbackQmlBridgef074ca_ExportListTransactions
func callbackQmlBridgef074ca_ExportListTransactions(ptr unsafe.Pointer) {
...
func (ptr *QmlBridge) ExportListTransactions() {
	if ptr.Pointer() != nil {
		C.QmlBridgef074ca_ExportListTransactions(ptr.Pointer())
	}
}

//export callbackQmlBridgef074ca_RegisterToGo
func callbackQmlBridgef074ca_RegisterToGo(ptr unsafe.Pointer, object unsafe.Pointer) {
...
func (ptr *QmlBridge) RegisterToGo(object std_core.QObject_ITF) {
	if ptr.Pointer() != nil {
		C.QmlBridgef074ca_RegisterToGo(ptr.Pointer(), std_core.PointerFromQObject(object))
	}
}

//export callbackQmlBridgef074ca_DeregisterToGo
func callbackQmlBridgef074ca_DeregisterToGo(ptr unsafe.Pointer, objectName C.struct_Moc_PackedString) {
...
func (ptr *QmlBridge) DeregisterToGo(objectName string) {
	if ptr.Pointer() != nil {
		...
		C.QmlBridgef074ca_DeregisterToGo(ptr.Pointer(), C.struct_Moc_PackedString{data: objectNameC, len: C.longlong(len(objectName))})
	}
}

func QmlBridge_QRegisterMetaType() int {
	return int(int32(C.QmlBridgef074ca_QmlBridgef074ca_QRegisterMetaType()))
}
...
func QmlBridge_QRegisterMetaType2(typeName string) int {
	...
	return int(int32(C.QmlBridgef074ca_QmlBridgef074ca_QRegisterMetaType2(typeNameC)))
}
...
func QmlBridge_QmlRegisterType() int {
	return int(int32(C.QmlBridgef074ca_QmlBridgef074ca_QmlRegisterType()))
}
...
func QmlBridge_QmlRegisterType2(uri string, versionMajor int, versionMinor int, qmlName string) int {
	...
	return int(int32(C.QmlBridgef074ca_QmlBridgef074ca_QmlRegisterType2(uriC, C.int(int32(versionMajor)), C.int(int32(versionMinor)), qmlNameC)))
}
...
func QmlBridge_QmlRegisterUncreatableType(uri string, versionMajor int, versionMinor int, qmlName string, message string) int {
	...
	return int(int32(C.QmlBridgef074ca_QmlBridgef074ca_QmlRegisterUncreatableType(uriC, C.int(int32(versionMajor)), C.int(int32(versionMinor)), qmlNameC, C.struct_Moc_PackedString{data: messageC, len: C.longlong(len(message))})))
}
...
func (ptr *QmlBridge) __children_atList(i int) *std_core.QObject {
	if ptr.Pointer() != nil {
		tmpValue := std_core.NewQObjectFromPointer(C.QmlBridgef074ca___children_atList(ptr.Pointer(), C.int(int32(i))))
...
func (ptr *QmlBridge) __children_setList(i std_core.QObject_ITF) {
	if ptr.Pointer() != nil {
		C.QmlBridgef074ca___children_setList(ptr.Pointer(), std_core.PointerFromQObject(i))
	}
}

func (ptr *QmlBridge) __children_newList() unsafe.Pointer {
	return C.QmlBridgef074ca___children_newList(ptr.Pointer())
}

func (ptr *QmlBridge) __dynamicPropertyNames_atList(i int) *std_core.QByteArray {
	if ptr.Pointer() != nil {
		tmpValue := std_core.NewQByteArrayFromPointer(C.QmlBridgef074ca___dynamicPropertyNames_atList(ptr.Pointer(), C.int(int32(i))))
...
func (ptr *QmlBridge) __dynamicPropertyNames_setList(i std_core.QByteArray_ITF) {
	if ptr.Pointer() != nil {
		C.QmlBridgef074ca___dynamicPropertyNames_setList(ptr.Pointer(), std_core.PointerFromQByteArray(i))
	}
}

func (ptr *QmlBridge) __dynamicPropertyNames_newList() unsafe.Pointer {
	return C.QmlBridgef074ca___dynamicPropertyNames_newList(ptr.Pointer())
}

func (ptr *QmlBridge) __findChildren_atList(i int) *std_core.QObject {
	if ptr.Pointer() != nil {
		tmpValue := std_core.NewQObjectFromPointer(C.QmlBridgef074ca___findChildren_atList(ptr.Pointer(), C.int(int32(i))))
		if !qt.ExistsSignal(tmpValue.Pointer(), "destroyed") {
			tmpValue.ConnectDestroyed(func(*std_core.QObject) { tmpValue.SetPointer(nil) })
		}
		return tmpValue
...
func (ptr *QmlBridge) __findChildren_setList(i std_core.QObject_ITF) {
	if ptr.Pointer() != nil {
		C.QmlBridgef074ca___findChildren_setList(ptr.Pointer(), std_core.PointerFromQObject(i))
	}
}

func (ptr *QmlBridge) __findChildren_newList() unsafe.Pointer {
	return C.QmlBridgef074ca___findChildren_newList(ptr.Pointer())
}

func (ptr *QmlBridge) __findChildren_atList3(i int) *std_core.QObject {
	if ptr.Pointer() != nil {
		tmpValue := std_core.NewQObjectFromPointer(C.QmlBridgef074ca___findChildren_atList3(ptr.Pointer(), C.int(int32(i))))
		if !qt.ExistsSignal(tmpValue.Pointer(), "destroyed") {
			tmpValue.ConnectDestroyed(func(*std_core.QObject) { tmpValue.SetPointer(nil) })
		}
		return tmpValue
...
func (ptr *QmlBridge) __findChildren_setList3(i std_core.QObject_ITF) {
	if ptr.Pointer() != nil {
		C.QmlBridgef074ca___findChildren_setList3(ptr.Pointer(), std_core.PointerFromQObject(i))
	}
}

func (ptr *QmlBridge) __findChildren_newList3() unsafe.Pointer {
	return C.QmlBridgef074ca___findChildren_newList3(ptr.Pointer())
}

func NewQmlBridge(parent std_core.QObject_ITF) *QmlBridge {
	QmlBridge_QRegisterMetaType()
	tmpValue := NewQmlBridgeFromPointer(C.QmlBridgef074ca_NewQmlBridge(std_core.PointerFromQObject(parent)))
	if !qt.ExistsSignal(tmpValue.Pointer(), "destroyed") {
		tmpValue.ConnectDestroyed(func(*std_core.QObject) { tmpValue.SetPointer(nil) })
	}
	return tmpValue
...
//export callbackQmlBridgef074ca_DestroyQmlBridge
func callbackQmlBridgef074ca_DestroyQmlBridge(ptr unsafe.Pointer) {
...
func (ptr *QmlBridge) DestroyQmlBridge() {
	if ptr.Pointer() != nil {
		...
		C.QmlBridgef074ca_DestroyQmlBridge(ptr.Pointer())
		ptr.SetPointer(nil)
	}
}
...
func (ptr *QmlBridge) DestroyQmlBridgeDefault() {
	if ptr.Pointer() != nil {
		...
		qt.SetFinalizer(ptr, nil)
		C.QmlBridgef074ca_DestroyQmlBridgeDefault(ptr.Pointer())
		ptr.SetPointer(nil)
	}
}

//export callbackQmlBridgef074ca_ChildEvent
func callbackQmlBridgef074ca_ChildEvent(ptr unsafe.Pointer, event unsafe.Pointer) {
...
func (ptr *QmlBridge) ChildEventDefault(event std_core.QChildEvent_ITF) {
	if ptr.Pointer() != nil {
		C.QmlBridgef074ca_ChildEventDefault(ptr.Pointer(), std_core.PointerFromQChildEvent(event))
	}
}

//export callbackQmlBridgef074ca_ConnectNotify
func callbackQmlBridgef074ca_ConnectNotify(ptr unsafe.Pointer, sign unsafe.Pointer) {
...
func (ptr *QmlBridge) ConnectNotifyDefault(sign std_core.QMetaMethod_ITF) {
	if ptr.Pointer() != nil {
		C.QmlBridgef074ca_ConnectNotifyDefault(ptr.Pointer(), std_core.PointerFromQMetaMethod(sign))
	}
}

//export callbackQmlBridgef074ca_CustomEvent
func callbackQmlBridgef074ca_CustomEvent(ptr unsafe.Pointer, event unsafe.Pointer) {
...
func (ptr *QmlBridge) CustomEventDefault(event std_core.QEvent_ITF) {
	if ptr.Pointer() != nil {
		C.QmlBridgef074ca_CustomEventDefault(ptr.Pointer(), std_core.PointerFromQEvent(event))
	}
}

//export callbackQmlBridgef074ca_DeleteLater
func callbackQmlBridgef074ca_DeleteLater(ptr unsafe.Pointer) {
...
func (ptr *QmlBridge) DeleteLaterDefault() {
	if ptr.Pointer() != nil {
		...
		qt.SetFinalizer(ptr, nil)
		C.QmlBridgef074ca_DeleteLaterDefault(ptr.Pointer())
	}
}

//export callbackQmlBridgef074ca_Destroyed
func callbackQmlBridgef074ca_Destroyed(ptr unsafe.Pointer, obj unsafe.Pointer) {
...
//export callbackQmlBridgef074ca_DisconnectNotify
func callbackQmlBridgef074ca_DisconnectNotify(ptr unsafe.Pointer, sign unsafe.Pointer) {
...
func (ptr *QmlBridge) DisconnectNotifyDefault(sign std_core.QMetaMethod_ITF) {
	if ptr.Pointer() != nil {
		C.QmlBridgef074ca_DisconnectNotifyDefault(ptr.Pointer(), std_core.PointerFromQMetaMethod(sign))
	}
}

//export callbackQmlBridgef074ca_Event
func callbackQmlBridgef074ca_Event(ptr unsafe.Pointer, e unsafe.Pointer) C.char {
...
func (ptr *QmlBridge) EventDefault(e std_core.QEvent_ITF) bool {
	if ptr.Pointer() != nil {
		return int8(C.QmlBridgef074ca_EventDefault(ptr.Pointer(), std_core.PointerFromQEvent(e))) != 0
	}
	return false
}

//export callbackQmlBridgef074ca_EventFilter
func callbackQmlBridgef074ca_EventFilter(ptr unsafe.Pointer, watched unsafe.Pointer, event unsafe.Pointer) C.char {
...
func (ptr *QmlBridge) EventFilterDefault(watched std_core.QObject_ITF, event std_core.QEvent_ITF) bool {
	if ptr.Pointer() != nil {
		return int8(C.QmlBridgef074ca_EventFilterDefault(ptr.Pointer(), std_core.PointerFromQObject(watched), std_core.PointerFromQEvent(event))) != 0
	}
	return false
}

//export callbackQmlBridgef074ca_ObjectNameChanged
func callbackQmlBridgef074ca_ObjectNameChanged(ptr unsafe.Pointer, objectName C.struct_Moc_PackedString) {
...
//export callbackQmlBridgef074ca_TimerEvent
func callbackQmlBridgef074ca_TimerEvent(ptr unsafe.Pointer, event unsafe.Pointer) {
...
func (ptr *QmlBridge) TimerEventDefault(event std_core.QTimerEvent_ITF) {
	if ptr.Pointer() != nil {
		C.QmlBridgef074ca_TimerEventDefault(ptr.Pointer(), std_core.PointerFromQTimerEvent(event))
	}
}
